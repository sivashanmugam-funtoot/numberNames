...
function toNumberName(number) {
    ...
    var placeValues = ["", " thousand", " lakh", " crore"];
...
function toNumberNameTeOld (number){
    ...
    //var placeValues = ["", " వెయ్యి", " లక్ష", "కోటి"];
    var placeValues = {
        "0":{
            "1P":"", 
            "E1_P":"",
        ...
        "1":{
            "1P":"ఒకవెయ్యి", //[P => Place (Here p mentions Thousand)]   When Exactly 1000
            "E1_P":"వేలు", //[Except 1] Except 1000, for 2000, 3000 ...,
            "1P*":"ఒకవెయ్యి", //[One Thousand And] 1***  
            "E1_P*":"వేల" //[Except 1, For Thousand And] Like 2***, 3*** ...
        },"2":{
            "1P":"ఒకలక్ష", //[P => Place (Here p mentions Lack)]   When Exactly 1000
            "E1_P":"లక్షలు", //[Except 1] 
            "1P*":"ఒకలక్ష", //[One Lack And] 
            "E1_P*":"లక్షల" //[Except 1, For Lack And] 
        },"3":{
            "1P":"ఒకకోటి", //[P => Place (Here p mentions Crore)]
            "E1_P":"ఒకకోట్లు", //[Except 1] 
            "1P*":"ఒకకోటి", //[One Crere And] 1
            "E1_P*":"కోట్ల" //[Except 1, For Crore And]
        },
    }
    var type = "te";
